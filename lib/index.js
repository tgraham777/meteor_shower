...
function gameOverLoop() {
  ...
  context.fillText("Play Again?", 105, 200);
...
function clearScreen() {
  $(function() {
    $("#screen").css("background-image", "url('../images/background/sad-face.png')");
    $("#screen").css("background-size", "450px 400px");
  });
}
