function Meteor(board, level, xDim, yDim) {
  ...
  var randomWidth = Math.floor(Math.random() * 40) + 16;
  var randomHeight = Math.floor(Math.random() * 40) + 16;
  var randomWidth2 = Math.floor(Math.random() * 25) + 16;
  var randomHeight2 = Math.floor(Math.random() * 25) + 16;
  var randomWidth3 = Math.floor(Math.random() * 10) + 16;
  var randomHeight3 = Math.floor(Math.random() * 10) + 16;

  var yVelocity = Math.floor(Math.random() * 3) + 1;
  var xVelocity = Math.floor(Math.random() * 3) - Math.floor(Math.random() * 3);
  var yVelocity2 = Math.floor(Math.random() * 3) + 3;
  var yVelocity3 = Math.floor(Math.random() * 3) + 5;
  ...
  this.pointValue = Math.floor(-((this.size.width + this.size.height) / 2) + 57);
