...
var Runner = function() {
  ...
  var gameLoop = function() {
    ...
    var meteorsDestroyed = board.impactedMeteors.length;
    document.getElementById('score').innerHTML = "Score: " + score;
    document.getElementById('meteors-destroyed').innerHTML = "Meteors Destroyed: " + meteorsDestroyed;
    if(board.players.length >= 1) {
      ...
      requestAnimationFrame(gameLoop);
        ...
        window.alert("Game over! Your score was " + score + "." + " You destroyed " + meteorsDestroyed + " meteors.");
    }
  };
