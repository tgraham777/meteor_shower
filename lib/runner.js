...
var Runner = function(canvas, context, gameSize) {
  ...
  this.audio     = { meteorsDestroyed: ['./sounds/wrap-up.wav', './sounds/american.wav']}
};
...
Runner.prototype.playSound = function(oldScore) {
  var meteorDestroyedAudio = _.sample(this.audio.meteorsDestroyed)
  var destroyed = new Audio(meteorDestroyedAudio);
